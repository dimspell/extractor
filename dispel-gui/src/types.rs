...
impl Tab {
    ...
    pub fn label(&self) -> &str {
        match self {
            ...
            Tab::AllMapIniEditor => "AllMapIniEditor",
            Tab::DialogEditor => "DialogEditor",
            Tab::DialogueTextEditor => "DialogueTextEditor",
            Tab::DrawItemEditor => "DrawItemEditor",
            Tab::EventIniEditor => "EventIniEditor",
            Tab::EventNpcRefEditor => "EventNpcRefEditor",
            Tab::ExtraIniEditor => "ExtraIniEditor",
            Tab::ExtraRefEditor => "ExtraRefEditor",
            Tab::MapIniEditor => "MapIniEditor",
            Tab::MessageScrEditor => "MessageScrEditor",
            Tab::NpcRefEditor => "NpcRefEditor",
            Tab::PartyLevelDbEditor => "PartyLevelDbEditor",
            Tab::QuestScrEditor => "QuestScrEditor",
            Tab::WaveIniEditor => "WaveIniEditor",
            Tab::ChDataEditor => "ChDataEditor",
        }
    }
}
...
impl RefOp {
    ...
    pub fn cli_name(&self) -> &str {
        match self {
            ...
            RefOp::DialogTexts => "dialog-texts",
            RefOp::Dialog => "dialog",
