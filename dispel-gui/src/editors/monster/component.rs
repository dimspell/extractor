use crate::components::editable::{set_i32_enum, set_int, set_str, EditableRecord, FieldDescriptor, FieldKind};
...
impl EditableRecord for Monster {
    ...
    fn set_field(&mut self, field: &str, value: String) -> bool {
        match field {
            ...
            "health_points_max" => set_int(&mut self.health_points_max, value),
            "health_points_min" => set_int(&mut self.health_points_min, value),
            "mana_points_max" => set_int(&mut self.mana_points_max, value),
            "mana_points_min" => set_int(&mut self.mana_points_min, value),
            "walk_speed" => set_int(&mut self.walk_speed, value),
            "to_hit_max" => set_int(&mut self.to_hit_max, value),
            "to_hit_min" => set_int(&mut self.to_hit_min, value),
            "to_dodge_max" => set_int(&mut self.to_dodge_max, value),
            "to_dodge_min" => set_int(&mut self.to_dodge_min, value),
            "offense_max" => set_int(&mut self.offense_max, value),
            "offense_min" => set_int(&mut self.offense_min, value),
            "defense_max" => set_int(&mut self.defense_max, value),
            "defense_min" => set_int(&mut self.defense_min, value),
            "magic_attack_max" => set_int(&mut self.magic_attack_max, value),
            "magic_attack_min" => set_int(&mut self.magic_attack_min, value),
            "is_undead" => {
                self.is_undead = if value == "true" {
            ...
            "ai_type" => set_i32_enum(&mut self.ai_type, value, MonsterAiType::from_i32),
            "exp_gain_max" => set_int(&mut self.exp_gain_max, value),
            "exp_gain_min" => set_int(&mut self.exp_gain_min, value),
            "gold_drop_max" => set_int(&mut self.gold_drop_max, value),
            "gold_drop_min" => set_int(&mut self.gold_drop_min, value),
            "detection_sight_size" => set_int(&mut self.detection_sight_size, value),
            "distance_range_size" => set_int(&mut self.distance_range_size, value),
            "known_spell_slot1" => set_int(&mut self.known_spell_slot1, value),
            "known_spell_slot2" => set_int(&mut self.known_spell_slot2, value),
            "known_spell_slot3" => set_int(&mut self.known_spell_slot3, value),
            "is_oversize" => set_int(&mut self.is_oversize, value),
            "magic_level" => set_int(&mut self.magic_level, value),
            "special_attack" => set_int(&mut self.special_attack, value),
            "special_attack_chance" => set_int(&mut self.special_attack_chance, value),
            "special_attack_duration" => set_int(&mut self.special_attack_duration, value),
            "boldness" => set_int(&mut self.boldness, value),
            "attack_speed" => set_int(&mut self.attack_speed, value),
            _ => false,
        }
    }
