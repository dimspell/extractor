...
editable_record_fields!(MagicSpell, {
    ...
    { effect_visual_blends_with_background = Enum(MagicSpellFlag, ["Disabled", "Enabled"]) / "Effect Visual Blends:" },
    ...
    { effect_animation_repeats = Enum(MagicSpellFlag, ["Disabled", "Enabled"]) / "Effect Animation Repeats:" },
    { range = Integer / "Range:" },
    { reserved_0x24 = Integer / "Reserved (0x24):" },
    { cast_duration = Integer / "Cast Duration:" },
    { unused_constant_one = Integer / "Unused Constant (0x2C):" },
    ...
    { target_animation_blends_with_background = Enum(MagicSpellFlag, ["Disabled", "Enabled"]) / "Target Animation Blends:" },
