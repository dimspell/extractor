                                ...
                                monsters: map
                                    ...
                                    .map(|m| {
                                        vec![
                                            ...
                                            m.unknown_runtime_1.to_string(),
                                            m.unknown_runtime_2.to_string(),
                                            m.awake_flag.to_string(),
                                            m.unknown_runtime_3.to_string(),
                                            ...
                                            m.unknown_patrol_flag.to_string(),
                                            m.unknown_cleared_on_death_1.to_string(),
                                            m.unknown_cleared_on_death_2.to_string(),
                                            m.spawn_group_id.to_string(),
                                            m.constructor_marker.to_string(),
                                            m.unknown_cleared_on_death_3.to_string(),
                                            m.dead_or_removed_flag.to_string(),
                                            m.unknown_runtime_flag_0.to_string(),
                                            m.unknown_map_data.to_string(),
                                            m.unknown_runtime_4.to_string(),
                                            m.unknown_runtime_5.to_string(),
                                            m.unknown_runtime_flag_1.to_string(),
                                            m.unknown_runtime_6.to_string(),
                                            m.unknown_runtime_flag_2.to_string(),
                                            m.unknown_runtime_7.to_string(),
                                            m.constructor_unknown_negative_one.to_string(),
                                            m.path_buffer_present_flag.to_string(),
                                            m.unknown_cleared_on_death_4.to_string(),
                                            ...
                                            m.unknown_runtime_8.to_string(),
                                            m.unknown_runtime_9.to_string(),
                                            m.special_attack.to_string(),
                                            m.special_attack_chance.to_string(),
                                            m.special_attack_duration.to_string(),
                                            m.unknown_runtime_10.to_string(),
                                            m.unknown_runtime_11.to_string(),
                                            m.boldness.to_string(),
                                            m.attack_speed.to_string(),
                                            m.guard_flag.to_string(),
                                            m.unknown_runtime_flag_3.to_string(),
                                            m.unknown_runtime_12.to_string(),
                                            m.unknown_runtime_flag_4.to_string(),
                                            m.unknown_runtime_13.to_string(),
                                            m.unknown_runtime_14.to_string(),
                                            m.unknown_runtime_flag_5.to_string(),
                                            m.unknown_runtime_15.to_string(),
                                ...
                                npcs: map
                                    ...
                                    .map(|n| {
                                        vec![
                                            ...
                                            n.runtime_state_78.to_string(),
                                            n.runtime_state_79.to_string(),
                                            ...
                                            n.unknown_runtime_7d.to_string(),
                                            n.unknown_runtime_7e.to_string(),
                                            n.unknown_runtime_7f.to_string(),
                                            n.unknown_runtime_80.to_string(),
                                            n.current_waypoint_index.to_string(),
                                            n.unknown_runtime_82.to_string(),
                                            n.wait_tick_counter.to_string(),
                                            n.unknown_runtime_90.to_string(),
                                            n.unknown_runtime_94.to_string(),
                                            n.npc_ref_party_script_id.to_string(),
                                            n.npc_ref_show_on_event_id.to_string(),
                                            n.npc_ref_behavior_type.to_string(),
