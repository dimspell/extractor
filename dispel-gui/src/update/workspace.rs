    ...
    match message {
        ...
        WorkspaceMessage::ToggleSidebar => {
            ...
            if app.sidebar_visible {
                ...
                let result =
                    new_state.split(Axis::Vertical, sidebar_pane, PaneContent::MainContent);
                if let Some((main_pane, split)) = result {
                    ...
                    if app.history_panel_visible {
                        if let Some((history_pane, _)) =
                            new_state.split(Axis::Vertical, main_pane, PaneContent::HistoryPanel)
                        {
