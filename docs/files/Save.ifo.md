...
- **Format**: fixed size of 224 bytes — six 32-byte slot records followed by a 32-byte global tail, addressed as two
  blocks: bytes 0–191 (slots) and 192–223 (tail).
...
| 204 | u32  | reserved; zero in known files                                                                 |
