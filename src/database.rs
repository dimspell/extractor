...
fn add_monster(conn: &Connection, monster: &Monster) -> Result<()> {
    conn.execute(
        ...
        params![
            ...
            monster.magic_stat3,
            monster.red_dragon,
            monster.non_magic_stat1,
            monster.non_magic_stat2,
            monster.non_magic_stat3,
            monster.unknown_stat1,
            monster.unknown_stat2,
            monster.unknown_stat3,
            monster.unknown_stat4,
            monster.unknown_stat5,
            monster.unknown_stat6,
            monster.unknown_stat7,
        ],
    )?;
    Ok(())
}
